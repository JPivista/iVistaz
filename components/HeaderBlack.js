      ...
      <Container className="w-80">
        <nav class="navbar bg-color z-index-100">
          <div class="container-fluid p-0">
            ...
            >
              <FaBars size={27} onClick={handleShow} />
            </Button>
          </div>
        </nav>
      </Container>
          ...
          <Row className="d-flex flex-column justify-content-between h-100">
            <Col>
              ...
              <NavDropdown.Item href="/service/videos">
                ...
                <li class="nav-item">
                  <Link class="nav-link" href="/mastery/solutions">
                    Solutions
                  </Link>
                </li>
                <li className="divider-center">
                ...
                <NavDropdown title="Industries" id="navbarScrollingDropdown">
                  <NavDropdown.Item href="/industries/appliances">
                    Appliances
                  </NavDropdown.Item>
                  {/* <NavDropdown.Divider /> */}
                  <NavDropdown.Item href="/industries/automobiles">
                    Automobiles
                  </NavDropdown.Item>
                  {/* <NavDropdown.Divider /> */}
                  <NavDropdown.Item href="/industries/beauty">
                    Beauty & Wellness
                  </NavDropdown.Item>
                  {/* <NavDropdown.Divider /> */}
                  <NavDropdown.Item href="/industries/fashion">
                    Fashion & Accessories
                  </NavDropdown.Item>
                  {/* <NavDropdown.Divider /> */}
                  <NavDropdown.Item href="/industries/hospitality">
                    Hospitality
                  </NavDropdown.Item>
                  {/* <NavDropdown.Divider /> */}
                  <NavDropdown.Item href="/industries/jewellery">
                    Jewellery
                  </NavDropdown.Item>
                  {/* <NavDropdown.Divider /> */}
                  <NavDropdown.Item href="/industries/ngo">
                    Not-for-Profits/NGOs
                  </NavDropdown.Item>
                  {/* <NavDropdown.Divider /> */}
                  <NavDropdown.Item href="/industries/tech">
                    Tech/IT
                  </NavDropdown.Item>
                  {/* <NavDropdown.Divider /> */}
              ...
              `} */}
                  ...
                  {/* <NavDropdown.Divider /> */}
                  <NavDropdown.Item href="/mastery/about-us">
                    About Us
                  </NavDropdown.Item>
                  {/* <NavDropdown.Divider /> */}
                  <NavDropdown.Item href="/careers">Careers</NavDropdown.Item>
                  <NavDropdown.Item href="/map-philosophy">
                    Map Philosophy
                  </NavDropdown.Item>
                </NavDropdown>
                {/* <li className="divider-center">
