    ...
    return (
        <>
            <Container className="w-80 mt-4" >
                <h1 className='fs-3 text-red fw-bold'>Design</h1>
                <Col>
                    ...
                    <p className="text-black para-text">
                        conveying your brand&apos;s message effectively. Our design services encompass various facets, including web design, logo design, collateral creation (brochures, white papers, case studies, etc.), infographic design, PowerPoint presentations, and newsletter design.
                    </p>
